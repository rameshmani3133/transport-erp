...
export default function RecurringBills() {
  ...
  return <div style={{ padding: '20px', maxWidth: '1500px', margin: '0 auto' }}>
    ...
    <DataTable data={bills} columns={columns} title="Monthly Payment Register" enableColumnFilters recycleBinType="recurringBills" onRecycleChanged={loadData} onNavigateRecord={editBill} activeRecordId={editId} />
