    ...
    if (isStandaloneTaxInvoice) {
      ...
      printWindow.document.write(`
        <html><head><title>${escapeHtml(invoice.invoiceNo)} - ${formatTitle}</title><style>
          ...
          .words,.declaration{padding:8px 10px;border-top:1px solid #222}.declaration{min-height:180px}.declaration p{margin-top:8px;line-height:1.4}.sign{text-align:right;margin-top:18px;font-weight:700;line-height:1.4}.signature-space{height:20mm}.sign-company{font-size:17px}.sign-role{font-size:16px}
        </style></head><body>
