          ...
          <div class="box"><div class="title">TAX INVOICE</div>
            ...
            <table class="items"><thead><tr><th style="width:12%">Slr No</th><th>Name of Product / Service</th><th style="width:18%">SAC</th><th style="width:24%">Total Amount (Rs.)</th></tr></thead><tbody>
              ...
              ${num(invoice.gstPercent) === 0
                ...
                : invoice.gstType === 'CGST_SGST'
                ? `<tr><td colspan="3" class="right">SGST ${num(invoice.gstPercent) / 2}%</td><td class="right">${num(invoice.sgst).toFixed(2)}</td></tr><tr><td colspan="3" class="right">CGST ${num(invoice.gstPercent) / 2}%</td><td class="right">${num(invoice.cgst).toFixed(2)}</td></tr>`
            ...
            <div class="declaration-grid"><div class="declaration"><strong>Declaration</strong><p>${escapeHtml(declarationText)}</p></div><div class="sign"><span class="sign-company">For ${escapeHtml(supplierName)}</span><div class="signature-space"></div><span class="sign-role">${escapeHtml(profile.signatoryRole || 'Authorized Signatory')}</span></div></div>
